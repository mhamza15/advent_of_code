...
-file("/Users/hove/dev/advent_of_code/2024/day02/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 31).
-spec from(any()) -> dynamic_().
from(A) ->
    gleam_stdlib:identity(A).

-file("/Users/hove/dev/advent_of_code/2024/day02/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 39).
-spec dynamic(dynamic_()) -> {ok, dynamic_()} | {error, list(decode_error())}.
dynamic(Value) ->
    {ok, Value}.

-file("/Users/hove/dev/advent_of_code/2024/day02/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 60).
-spec bit_array(dynamic_()) -> {ok, bitstring()} | {error, list(decode_error())}.
bit_array(Data) ->
    gleam_stdlib:decode_bit_array(Data).

-file("/Users/hove/dev/advent_of_code/2024/day02/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 107).
-spec put_expected(decode_error(), binary()) -> decode_error().
put_expected(Error, Expected) ->
    erlang:setelement(2, Error, Expected).

-file("/Users/hove/dev/advent_of_code/2024/day02/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 120).
-spec classify(dynamic_()) -> binary().
classify(Data) ->
    gleam_stdlib:classify_dynamic(Data).

-file("/Users/hove/dev/advent_of_code/2024/day02/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 137).
-spec int(dynamic_()) -> {ok, integer()} | {error, list(decode_error())}.
int(Data) ->
    gleam_stdlib:decode_int(Data).

-file("/Users/hove/dev/advent_of_code/2024/day02/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 160).
-spec float(dynamic_()) -> {ok, float()} | {error, list(decode_error())}.
float(Data) ->
    gleam_stdlib:decode_float(Data).

-file("/Users/hove/dev/advent_of_code/2024/day02/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 183).
-spec bool(dynamic_()) -> {ok, boolean()} | {error, list(decode_error())}.
bool(Data) ->
    gleam_stdlib:decode_bool(Data).

-file("/Users/hove/dev/advent_of_code/2024/day02/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 209).
-spec shallow_list(dynamic_()) -> {ok, list(dynamic_())} |
    {error, list(decode_error())}.
shallow_list(Value) ->
    gleam_stdlib:decode_list(Value).

-file("/Users/hove/dev/advent_of_code/2024/day02/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 352).
-spec optional(fun((dynamic_()) -> {ok, CHR} | {error, list(decode_error())})) -> fun((dynamic_()) -> {ok,
        gleam@option:option(CHR)} |
    {error, list(decode_error())}).
optional(Decode) ->
    fun(Value) -> gleam_stdlib:decode_option(Value, Decode) end.

-file("/Users/hove/dev/advent_of_code/2024/day02/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 487).
...
-file("/Users/hove/dev/advent_of_code/2024/day02/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 1017).
-spec any(list(fun((dynamic_()) -> {ok, CLR} | {error, list(decode_error())}))) -> fun((dynamic_()) -> {ok,
        CLR} |
    {error, list(decode_error())}).
any(Decoders) ->
...
-file("/Users/hove/dev/advent_of_code/2024/day02/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 1513).
...
-file("/Users/hove/dev/advent_of_code/2024/day02/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 1050).
-spec decode1(
    fun((CLV) -> CLW),
...
-file("/Users/hove/dev/advent_of_code/2024/day02/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 559).
...
-file("/Users/hove/dev/advent_of_code/2024/day02/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 240).
-spec result(
    fun((dynamic_()) -> {ok, CGZ} | {error, list(decode_error())}),
    fun((dynamic_()) -> {ok, CHB} | {error, list(decode_error())})
) -> fun((dynamic_()) -> {ok, {ok, CGZ} | {error, CHB}} |
    {error, list(decode_error())}).
...
-file("/Users/hove/dev/advent_of_code/2024/day02/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 297).
-spec list(fun((dynamic_()) -> {ok, CHM} | {error, list(decode_error())})) -> fun((dynamic_()) -> {ok,
        list(CHM)} |
    {error, list(decode_error())}).
list(Decoder_type) ->
    fun(Dynamic) ->
...
-file("/Users/hove/dev/advent_of_code/2024/day02/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 87).
-spec map_errors(
    {ok, CGA} | {error, list(decode_error())},
...
-file("/Users/hove/dev/advent_of_code/2024/day02/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 95).
...
-file("/Users/hove/dev/advent_of_code/2024/day02/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 83).
-spec string(dynamic_()) -> {ok, binary()} | {error, list(decode_error())}.
string(Data) ->
    decode_string(Data).

-file("/Users/hove/dev/advent_of_code/2024/day02/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 381).
-spec field(
    any(),
...
-file("/Users/hove/dev/advent_of_code/2024/day02/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 423).
-spec optional_field(
    any(),
    fun((dynamic_()) -> {ok, CIF} | {error, list(decode_error())})
) -> fun((dynamic_()) -> {ok, gleam@option:option(CIF)} |
    {error, list(decode_error())}).
...
-file("/Users/hove/dev/advent_of_code/2024/day02/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 466).
-spec element(
    integer(),
...
-file("/Users/hove/dev/advent_of_code/2024/day02/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 549).
...
-file("/Users/hove/dev/advent_of_code/2024/day02/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 625).
-spec tuple2(
    fun((dynamic_()) -> {ok, CJN} | {error, list(decode_error())}),
    fun((dynamic_()) -> {ok, CJP} | {error, list(decode_error())})
) -> fun((dynamic_()) -> {ok, {CJN, CJP}} | {error, list(decode_error())}).
...
-file("/Users/hove/dev/advent_of_code/2024/day02/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 694).
-spec tuple3(
...
) -> fun((dynamic_()) -> {ok, {CJS, CJU, CJW}} | {error, list(decode_error())}).
...
-file("/Users/hove/dev/advent_of_code/2024/day02/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 765).
-spec tuple4(
...
) -> fun((dynamic_()) -> {ok, {CJZ, CKB, CKD, CKF}} |
    {error, list(decode_error())}).
...
-file("/Users/hove/dev/advent_of_code/2024/day02/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 838).
-spec tuple5(
...
) -> fun((dynamic_()) -> {ok, {CKI, CKK, CKM, CKO, CKQ}} |
    {error, list(decode_error())}).
...
-file("/Users/hove/dev/advent_of_code/2024/day02/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 913).
-spec tuple6(
...
) -> fun((dynamic_()) -> {ok, {CKT, CKV, CKX, CKZ, CLB, CLD}} |
    {error, list(decode_error())}).
...
-file("/Users/hove/dev/advent_of_code/2024/day02/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 964).
-spec dict(
    fun((dynamic_()) -> {ok, CLG} | {error, list(decode_error())}),
    fun((dynamic_()) -> {ok, CLI} | {error, list(decode_error())})
) -> fun((dynamic_()) -> {ok, gleam@dict:dict(CLG, CLI)} |
    {error, list(decode_error())}).
...
-file("/Users/hove/dev/advent_of_code/2024/day02/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 1078).
-spec decode2(
    fun((CLZ, CMA) -> CMB),
...
-file("/Users/hove/dev/advent_of_code/2024/day02/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 1110).
-spec decode3(
    fun((CMF, CMG, CMH) -> CMI),
...
-file("/Users/hove/dev/advent_of_code/2024/day02/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 1156).
-spec decode4(
    fun((CMN, CMO, CMP, CMQ) -> CMR),
...
-file("/Users/hove/dev/advent_of_code/2024/day02/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 1212).
-spec decode5(
    fun((CMX, CMY, CMZ, CNA, CNB) -> CNC),
...
-file("/Users/hove/dev/advent_of_code/2024/day02/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 1272).
-spec decode6(
    fun((CNJ, CNK, CNL, CNM, CNN, CNO) -> CNP),
...
-file("/Users/hove/dev/advent_of_code/2024/day02/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 1337).
-spec decode7(
    fun((CNX, CNY, CNZ, COA, COB, COC, COD) -> COE),
    fun((dynamic_()) -> {ok, CNX} | {error, list(decode_error())}),
...
-file("/Users/hove/dev/advent_of_code/2024/day02/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 1406).
-spec decode8(
    fun((CON, COO, COP, COQ, COR, COS, COT, COU) -> COV),
...
-file("/Users/hove/dev/advent_of_code/2024/day02/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 1479).
-spec decode9(
    fun((CPF, CPG, CPH, CPI, CPJ, CPK, CPL, CPM, CPN) -> CPO),
